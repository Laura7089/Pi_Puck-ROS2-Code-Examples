...
# return nulls
    ...
    #  Therefore, for all invalid ranges we put 0 so it get deleted by rviz
        ...
        )[2] + SENSOR_DIST_FROM_CENTER
        data[1174] = self.tof_sensors['tof0'].getRangeImage(
        )[3] + SENSOR_DIST_FROM_CENTER
        data[1182] = self.tof_sensors['tof0'].getRangeImage(
        )[4] + SENSOR_DIST_FROM_CENTER
        data[1190] = self.tof_sensors['tof0'].getRangeImage(
        )[5] + SENSOR_DIST_FROM_CENTER
        data[1198] = self.tof_sensors['tof0'].getRangeImage(
        )[6] + SENSOR_DIST_FROM_CENTER
        data[1206] = self.tof_sensors['tof0'].getRangeImage(
        )[7] + SENSOR_DIST_FROM_CENTER
        data[1214] = self.tof_sensors['tof0'].getRangeImage(
        )[8] + SENSOR_DIST_FROM_CENTER
        data[1222] = self.tof_sensors['tof0'].getRangeImage(
        )[9] + SENSOR_DIST_FROM_CENTER
        data[1230] = self.tof_sensors['tof0'].getRangeImage(
        )[10] + SENSOR_DIST_FROM_CENTER
        ...
        data[1399] = self.tof_sensors['tof1'].getRangeImage(
        )[3] + SENSOR_DIST_FROM_CENTER
        data[1407] = self.tof_sensors['tof1'].getRangeImage(
        )[4] + SENSOR_DIST_FROM_CENTER
        data[1415] = self.tof_sensors['tof1'].getRangeImage(
        )[5] + SENSOR_DIST_FROM_CENTER
        data[1423] = self.tof_sensors['tof1'].getRangeImage(
        )[6] + SENSOR_DIST_FROM_CENTER
        data[1431] = self.tof_sensors['tof1'].getRangeImage(
        )[7] + SENSOR_DIST_FROM_CENTER
        data[1439] = self.tof_sensors['tof1'].getRangeImage(
        )[8] + SENSOR_DIST_FROM_CENTER
        data[1447] = self.tof_sensors['tof1'].getRangeImage(
        )[9] + SENSOR_DIST_FROM_CENTER
        data[1455] = self.tof_sensors['tof1'].getRangeImage(
        )[10] + SENSOR_DIST_FROM_CENTER
        ...
        data[49] = self.tof_sensors['tof2'].getRangeImage(
        )[3] + SENSOR_DIST_FROM_CENTER
        data[57] = self.tof_sensors['tof2'].getRangeImage(
        )[4] + SENSOR_DIST_FROM_CENTER
        data[65] = self.tof_sensors['tof2'].getRangeImage(
        )[5] + SENSOR_DIST_FROM_CENTER
        data[73] = self.tof_sensors['tof2'].getRangeImage(
        )[6] + SENSOR_DIST_FROM_CENTER
        data[81] = self.tof_sensors['tof2'].getRangeImage(
        )[7] + SENSOR_DIST_FROM_CENTER
        data[89] = self.tof_sensors['tof2'].getRangeImage(
        )[8] + SENSOR_DIST_FROM_CENTER
        data[97] = self.tof_sensors['tof2'].getRangeImage(
        )[9] + SENSOR_DIST_FROM_CENTER
        data[105] = self.tof_sensors['tof2'].getRangeImage(
        )[10] + SENSOR_DIST_FROM_CENTER
        ...
        data[274] = self.tof_sensors['tof3'].getRangeImage(
        )[3] + SENSOR_DIST_FROM_CENTER
        data[282] = self.tof_sensors['tof3'].getRangeImage(
        )[4] + SENSOR_DIST_FROM_CENTER
        data[290] = self.tof_sensors['tof3'].getRangeImage(
        )[5] + SENSOR_DIST_FROM_CENTER
        data[298] = self.tof_sensors['tof3'].getRangeImage(
        )[6] + SENSOR_DIST_FROM_CENTER
        data[306] = self.tof_sensors['tof3'].getRangeImage(
        )[7] + SENSOR_DIST_FROM_CENTER
        data[314] = self.tof_sensors['tof3'].getRangeImage(
        )[8] + SENSOR_DIST_FROM_CENTER
        data[322] = self.tof_sensors['tof3'].getRangeImage(
        )[9] + SENSOR_DIST_FROM_CENTER
        data[330] = self.tof_sensors['tof3'].getRangeImage(
        )[10] + SENSOR_DIST_FROM_CENTER
        ...
        data[499] = self.tof_sensors['tof4'].getRangeImage(
        )[3] + SENSOR_DIST_FROM_CENTER
        data[507] = self.tof_sensors['tof4'].getRangeImage(
        )[4] + SENSOR_DIST_FROM_CENTER
        data[515] = self.tof_sensors['tof4'].getRangeImage(
        )[5] + SENSOR_DIST_FROM_CENTER
        data[523] = self.tof_sensors['tof4'].getRangeImage(
        )[6] + SENSOR_DIST_FROM_CENTER
        data[531] = self.tof_sensors['tof4'].getRangeImage(
        )[7] + SENSOR_DIST_FROM_CENTER
        data[539] = self.tof_sensors['tof4'].getRangeImage(
        )[8] + SENSOR_DIST_FROM_CENTER
        data[547] = self.tof_sensors['tof4'].getRangeImage(
        )[9] + SENSOR_DIST_FROM_CENTER
        data[555] = self.tof_sensors['tof4'].getRangeImage(
        )[10] + SENSOR_DIST_FROM_CENTER
        ...
        data[949] = self.tof_sensors['tof5'].getRangeImage(
        )[3] + SENSOR_DIST_FROM_CENTER
        data[957] = self.tof_sensors['tof5'].getRangeImage(
        )[4] + SENSOR_DIST_FROM_CENTER
        data[965] = self.tof_sensors['tof5'].getRangeImage(
        )[5] + SENSOR_DIST_FROM_CENTER
        data[973] = self.tof_sensors['tof5'].getRangeImage(
        )[6] + SENSOR_DIST_FROM_CENTER
        data[981] = self.tof_sensors['tof5'].getRangeImage(
        )[7] + SENSOR_DIST_FROM_CENTER
        data[989] = self.tof_sensors['tof5'].getRangeImage(
        )[8] + SENSOR_DIST_FROM_CENTER
        data[997] = self.tof_sensors['tof5'].getRangeImage(
        )[9] + SENSOR_DIST_FROM_CENTER
        data[1005] = self.tof_sensors['tof5'].getRangeImage(
        )[10] + SENSOR_DIST_FROM_CENTER
